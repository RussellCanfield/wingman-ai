...
export class LlamaModel {
	public llamaCppNode: LlamaCppNodeModule | undefined;
	public _model: LLAMAModel | undefined;
	_context: LLAMAContext | undefined;
	_grammar: LLAMAGrammar | undefined;
	_grammarEval: LLAMAGrammarEvaluationState | undefined;
	...
	public async initialize({
		...
		"modelPath" | "gpuLayers" | "vocabOnly" | "useMmap" | "useMlock"
	> & { binPath: string }) {
		const llamaCppNode = await loadBin(binPath);
		this.llamaCppNode = llamaCppNode;
		const {
			LLAMAModel,
			LLAMAContext,
			LLAMAGrammar,
		...
		const fileUrl = new URL(modelPath);
		...
		this._context = LLAMAContext;
		this._grammar = LLAMAGrammar;
		this._grammarEval = LLAMAGrammarEvaluationState;
	}
}
