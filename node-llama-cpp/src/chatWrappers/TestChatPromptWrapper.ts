...
export class TestChatPromptWrapper extends ChatPromptWrapper {
	public readonly wrapperName: string = "Test";
	private readonly _instructionName: string;
	private readonly _responseName: string;

	public constructor({
		instructionName = "Human",
		responseName = "Assistant",
	}: { instructionName?: string; responseName?: string } = {}) {
		super();
