...
import { summarizeToolEventValue, ToolEventPanel } from "./ToolEventPanel";
...
export const ToolActivityRollup: React.FC<ToolActivityRollupProps> = ({
	toolEvents,
	className = "",
}) => {
	...
	const hasErrorTool = sortedToolEvents.some(
