...
## Packaging
The AppHost Xcode project is the packaging entry point. It depends on the `WingmanMacKit` Swift package and contains the app bundle assets, entitlements, and Info.plist strings. Update `Sources/WingmanMac/Resources/AppInfo.plist` to change permission prompts and keep `AppHost/Wingman/Wingman/Info.plist` in sync.
