...
| `game-dev` | Game feature orchestrator (code + assets + UI) | Yes (4) | Recommended | Template prefers FAL MCP media tools for generation flows and includes `browser_control` for WebGL/UI smoke testing. |
