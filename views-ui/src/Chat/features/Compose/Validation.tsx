...
const Validation = () => {
	...
	return (
		<div className="pl-[48px] pr-[16px]">
			<div className="border rounded-lg overflow-hidden shadow-lg mb-4 mt-4 bg-editor-bg/30 bg-stone-600 text-white flex items-center border-b border-stone-700/50 justify-between">
