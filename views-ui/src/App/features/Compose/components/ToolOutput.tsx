...
export const ToolOutput = ({ event, isLightTheme, loading }: { event: StreamEvent, isLightTheme: boolean, loading: boolean }) => {
    //@ts-expect-error
    ...
    return (<div className={`rounded-lg overflow-hidden shadow-lg mb-4 mt-4 ${cssClasses}`}>
