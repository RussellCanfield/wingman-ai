...
type OpenAiSection = InitSettings['openai'] & { onChange: (ollamaSettings: ApiSettingsType) => void };
export const OpenAISettingsView = ({ codeModel, chatModel, baseUrl, apiKey, onChange }: OpenAiSection) => {
  ...
  return (
    <Container>
      <VSCodeTextField onChange={handleChangeInput} value={codeModel} data-name='codeModel' title="OpenAI Code Model">
        Code Model:
      </VSCodeTextField>
      <VSCodeTextField onChange={handleChangeInput} value={chatModel} data-name='chatModel' title="OpenAI Chat Model">
        Chat Model:
      </VSCodeTextField>
