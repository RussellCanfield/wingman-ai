...
import { logStartup, logShutdown, getLogInfo, cliLogger } from "./utils/logger";
...
program
	...
	.action(async (promptParts: string[], options) => {
		...
		try {
			cliLogger.debug({ event: 'render_start' }, 'Starting Ink app render');
			...
			cliLogger.debug({ event: 'render_complete' }, 'Ink app rendered successfully');
