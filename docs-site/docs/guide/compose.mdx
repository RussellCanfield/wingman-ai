...
The idea of this feature is to extend functionality into bigger integrates in the future and allow teams to hook up other commands that should run post-change, such as linting, etc.